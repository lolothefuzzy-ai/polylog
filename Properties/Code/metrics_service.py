...
try:  # Optional dependency for Prometheus metrics export
    from prometheus_client import Counter, Gauge, Summary, start_http_server  # type: ignore
...
class MetricsService:
    ...
    def start(self, port: int = 8000) -> None:
        if not self._prometheus_available or start_http_server is None:
            return
...
__all__ = ["KPI", "KPIRegistry", "MetricsService", "metrics_service", "get_registry"]
